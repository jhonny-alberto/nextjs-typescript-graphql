...
// import { useAdvancedForm } from 'dsl-admin-base/hooks/advanced-search-form';
...
// import { SelectedItem, ProductsResponse } from 'types';
// import { ManageSelectedItems } from 'components/app/ManageSelectedItems';
// import { CategoryTree } from 'dsl-admin-base/components/CategoryTree';
...
//           </Checkbox.Group>
//         </Form.Item>
//         <Form.Item label="Search by product filter">
//           <Row gutter={25}>
//             {productData &&
//               productData.filters.map((filter) => {
//                 return (
//                   <Col key={filter.filterId} span={12}>
//                     <Text sx={{ mb: 1 }}>{filter.filter}</Text>
//                     <Form.Item name={`filter_variants[${filter.filterId}]`}>
...
export const ProductsSearchForm = () => null;
